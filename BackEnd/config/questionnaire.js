...
export const QUESTIONS = [
  ...
  {
    id: "queue_jumper",
    text: "Someone pushes in front of you in a long supermarket queue. You…",
    options: [
      { id: "a", text: "Politely point out the queue is back there — no drama",
        traits: { social: 0.8, pressure: 0.9, responsibility: 0.8 } },
      { id: "b", text: "Say nothing but it winds me up for ages",
        traits: { pressure: 0.3, social: 0.4 } },
      { id: "c", text: "Let it go — life's too short for queue politics",
        traits: { pressure: 0.8, social: 0.5, teamwork: 0.5 } },
      { id: "d", text: "Make a joke of it loud enough for everyone to laugh",
        traits: { social: 1.0, pressure: 0.7, energy: 0.6 } },
    ],
  },
  {
    id: "broke_something",
    text: "You accidentally break a glass at a friend's house party. You…",
    options: [
      { id: "a", text: "Tell them straight away and offer to replace it",
        traits: { responsibility: 1.0, social: 0.6 } },
      { id: "b", text: "Clean it up quietly and mention it later",
        traits: { responsibility: 0.7, routine: 0.5 } },
      { id: "c", text: "Clean it up and say nothing — it's just a glass",
        traits: { responsibility: 0.4 } },
      { id: "d", text: "Hope nobody heard it over the music",
        traits: { responsibility: 0.1, pressure: 0.4 } },
    ],
  },
  {
    id: "weekend_morning",
    text: "A typical weekend morning for you looks like…",
    options: [
      { id: "a", text: "Up early — gym, run or a swim before most people wake up",
        traits: { energy: 1.0, routine: 0.8, responsibility: 0.8 } },
      { id: "b", text: "Slow start, coffee, no fixed plans",
        traits: { routine: 0.4, energy: 0.4 } },
      { id: "c", text: "Sleeping in — my weekends start in the afternoon",
        traits: { energy: 0.3, routine: 0.3, social: 0.6 } },
      { id: "d", text: "Same little ritual every week — I like my routine",
        traits: { routine: 1.0, responsibility: 0.7 } },
    ],
  },
  {
    id: "try_new_thing",
    text: "Friends invite you to try something you've never done — salsa class, surfing, climbing. You…",
    options: [
      { id: "a", text: "I'm in before they finish the sentence",
        traits: { energy: 0.9, creativity: 0.8, pressure: 0.8, social: 0.7 } },
      { id: "b", text: "Come along, but I'll watch first before joining in",
        traits: { routine: 0.6, responsibility: 0.6, pressure: 0.5 } },
      { id: "c", text: "Only if a close friend does it with me",
        traits: { teamwork: 0.8, social: 0.5, pressure: 0.4 } },
      { id: "d", text: "Probably pass — I stick to what I enjoy already",
        traits: { routine: 1.0, creativity: 0.2 } },
    ],
  },
  {
    id: "perfect_day_off",
    text: "Your perfect day off is…",
    options: [
      { id: "a", text: "Outside all day — beach, hike, sea, sun",
        traits: { outdoors: 1.0, energy: 0.8 } },
      { id: "b", text: "A mix — morning outside, afternoon relaxing at home",
        traits: { outdoors: 0.6, energy: 0.5, routine: 0.5 } },
      { id: "c", text: "Exploring somewhere new — markets, towns, food spots",
        traits: { creativity: 0.7, social: 0.6, outdoors: 0.6, routine: 0.2 } },
      { id: "d", text: "Home comforts — sofa, snacks, screens, zero sunscreen",
        traits: { outdoors: 0.0, energy: 0.2, routine: 0.7 } },
    ],
  },
  {
    id: "cooking_missing",
    text: "You're cooking dinner and realize you're missing a key ingredient. You…",
    options: [
      { id: "a", text: "Improvise with whatever's in the cupboard",
        traits: { creativity: 1.0, pressure: 0.7 } },
      { id: "b", text: "Quick trip to the shop — the recipe is the recipe",
        traits: { routine: 0.9, responsibility: 0.7, creativity: 0.2 } },
      { id: "c", text: "Google a different recipe that fits what I've got",
        traits: { creativity: 0.7, responsibility: 0.6, routine: 0.4 } },
      { id: "d", text: "Give up and order takeaway",
        traits: { creativity: 0.2, energy: 0.3, pressure: 0.3 } },
    ],
  },
  {
    id: "group_trip",
    text: "You're planning a trip with friends and everyone wants something different. You're the one who…",
    options: [
      { id: "a", text: "Makes the spreadsheet, books the flights, sorts it all out",
        traits: { responsibility: 1.0, routine: 0.7, teamwork: 0.6 } },
      { id: "b", text: "Finds the compromise everyone can live with",
        traits: { teamwork: 1.0, social: 0.8, pressure: 0.6 } },
      { id: "c", text: "Is happy with whatever — I just want to go",
        traits: { teamwork: 0.7, pressure: 0.7, routine: 0.3 } },
      { id: "d", text: "Suggests the wild option nobody thought of",
        traits: { creativity: 1.0, energy: 0.7, social: 0.6 } },
    ],
  },
];
