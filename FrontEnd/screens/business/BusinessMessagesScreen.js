// FrontEnd/screens/business/BusinessMessagesScreen.js
// Business inbox: one row per conversation with a matched candidate,
      ...
      ListEmptyComponent={
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptySub}>
            Like an applicant who applied to you — matched candidates appear here.
          </Text>
        </View>
      }
    />
